...
import static entity.Product_.description;
import static entity.Product_.imageName;
import static entity.Product_.name;
import static entity.Product_.price;
...
@Inject
   StockBean stockBean = new StockBean();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            stockBean.createStock(idProduct, amount);
        }
        catch(Exception ex){
