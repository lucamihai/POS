        ...
        <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>${stock.ammount}</td>
                <td><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter">Update</button></td>
  ...
  <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <p>Enter ammount for product with barcode</p>
            <div class="form-group">
                <label for="barcode">Ammount</label>
                <input type="text" name="price" id="price" class="form-control" placeholder="Ammount">
            </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary btn-sm">Update ammount</button>
      </div>
    </div>
  </div>
</div>
